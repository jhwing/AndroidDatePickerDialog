...
public class NumberPickerView extends View {
    ...
    public interface OnGetDisplayValueListener {
    ...
    private OnGetDisplayValueListener mOnGetDisplayValueListener;
    ...
    public void setOnGetDisplayValueListener(OnGetDisplayValueListener onGetDisplayValueListener) {
        mOnGetDisplayValueListener = onGetDisplayValueListener;
    }
...
//        if (maxValue - mMinValue + 1 > getItemCount()) {
//            throw new IllegalArgumentException("(maxValue - mMinValue + 1) should not be greater than mDisplayedValues.length now " +
//                    " (maxValue - mMinValue + 1) is " + (maxValue - mMinValue + 1) + " and mDisplayedValues.length is " + getItemCount());
//        }
        mMaxValue = maxValue;
    ...
    public String getContentByCurrValue() {
        return getDisplayedValue(getValue() - mMinValue);
    }
...
//        }
    ...
    private void drawContent(Canvas canvas) {
        ...
        for (int i = 0; i < mShowCount + 1; i++) {
            ...
            if (0 <= index && index < getOneRecycleSize()) {
                CharSequence str = getDisplayedValue(index + mMinShowIndex);
    ...
    private String getDisplayedValue(int index) {
        if (mOnGetDisplayValueListener != null) {
            return mOnGetDisplayValueListener.getDisplayValue(index);
        }
    ...
    private void updateWrapStateByContent() {
        mWrapSelectorWheelCheck = getItemCount() <= mShowCount ? false : true;
    }
